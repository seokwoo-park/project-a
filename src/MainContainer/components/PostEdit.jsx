...
function PostEdit({postEditToggle,getList,idx,content,image}) {
    ...
    const [editImgStyle, setEditImgStyle] = useState({ objectFit: "contain", width: "100px" });
        ...
        <div className="postEdit">
            <form className="postEdit-form">
                ...
                <div className="postEdit_bnt_container">
                    <button className="postEdit_btn btn_close " onClick={postEditToggle}>Close</button>
                    <button className="postEdit_btn btn_edit" type="submit" onClick={EditPost}>Edit</button>
                </div>
            </form>
        </div>
    )
