...
router.get("/list", (req, res) => {
  let sql =
    "select board.idx, board.user_id, board.content, board.image, board.created, user.profile from side_project_board board inner join side_project_user user on board.user_id = user.user_id";
...
router.post("/mylist", isAuth, (req, res) => {
  ...
  let sql =
    "select board.idx, board.user_id, board.content, board.image, board.created, user.profile from side_project_board board inner join side_project_user user on board.user_id = user.user_id where user.user_id = ?";
